package com.chientran.application.controller.admin;

import com.chientran.application.entity.Order;
import com.chientran.application.entity.Promotion;
import com.chientran.application.entity.User;
import com.chientran.application.model.dto.OrderDetailDTO;
import com.chientran.application.model.dto.ShortProductInfoDTO;
import com.chientran.application.service.OrderService;
...
import com.chientran.application.model.dto.OrderInfoDTO;
import com.chientran.application.model.request.CreateOrderRequest;
import com.chientran.application.model.request.UpdateDetailOrder;
import com.chientran.application.model.request.UpdateStatusOrderRequest;
...
import static com.chientran.application.config.Contant.*;
...
//    @GetMapping("/tai-khoan/gio-hang/{id}")
//    public String getDetailCartPage(Model model, @PathVariable int id) {
//        User user = ((CustomUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getUser();
//
//        OrderDetailDTO order = orderService.userGetDetailById(id, user.getId());
//        if (order == null) {
